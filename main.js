    ...
    $(document).ready( (function() {
        ...
        try {
            ...
            var MyScene = function(gl, transformation) {
                ...
                this.prog_blue = new Program(gl, 
					                        shaders.vs_NoColor(), 
					                        shaders.fs_ConstantColor([0,0,1,1]) );
                this.prog_green = new Program(gl, 
					                        shaders.vs_NoColor(), 
					                        shaders.fs_ConstantColor([0,1,0,1]) );
            ...
            MyScene.prototype.draw = function() {
                ...
                setUniforms(this.prog_blue, this.transformation);
                setUniforms(this.prog_green, this.transformation);
                ...
                // draw the objects
                // TODO: vertexColor ge�ndert bei Trianle
